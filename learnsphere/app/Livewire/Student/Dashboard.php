...
class Dashboard extends Component
{
    ...
    {
        $user = Auth::user();
        $user->load('enrolledCourses'); // Eager load the relationship

        $this->enrolledCourses = $user->enrolledCourses->map(function ($course) use ($user) {
        ...
        $this->courseCatalog = Course::whereNotIn('id', $enrolledCourseIds)->get();
    }
